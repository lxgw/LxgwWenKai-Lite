...
作为原 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai) 字体的精简版，与 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai) 完整版相比，本字体剔除完整版增补的一些较不常用的汉字，恢复到过往版本 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai) 的字体文件体积。

若完整版有字形优化或特性更新，精简版也将会跟进（大量增字除外）。
...
- [x] 繁体中文 4808 常用汉字 *（台湾地区「常用国字标准字体表」）* ；
- [x] 「GB/T 12345-90」6866 个汉字；
- [x]  BIG5 一级（常用）汉字 5401 个；
- [x] 「通用规范汉字表」内汉字对应的繁体字或港台异体字；
- 常用粤语、闽南语、客家语用字。*（基于 [「常用香港外字表」](https://github.com/ichitenfont/suppchara)）*
  - [x] 常用香港外字表 A-C 级
  - [x] 常用香港外字表 1-2 级
  - [x] 常用香港外字表 3 级
  - [x] 台湾闽客汉字（外字表ㄅ级）
