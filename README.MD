...
作为 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai) 的精简版，与 v1.100 版本的 [霞鹜文楷](https://github.com/lxgw/LxgwWenKai) 相比，保留以往版本包含的常用汉字，字体文件体积更小。  
*（霞鹜文楷 v1.101 版 3 个字重总的文件体积为 43.5 MB，而轻便版 v1.101-lite 版本 3 字重总的文件体积为 26.1 MB。）*
